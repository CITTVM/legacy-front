<%-- 
    Document   : index
    Created on : Jun 19, 2017, 12:51:23 PM
    Author     : jordan
--%>
...
<body>
    ...
    <div data-bs-parallax-bg="true" style="height:500px;background-image:url(https://unsplash.it/1800/900?image=1051);background-position:center;background-size:cover;">
        <section>
            <div class="container">
                <div class="jumbotron" style="margin-top:100px;background-color:rgba(238,238,238,0.7);">
                    <h1>Noticias </h1>
                    <p>Noticias y Actualidad del Centro de Innovación y Transferencia Tecnológica de la sede Viña del Mar.</p>
                    <p><a class="btn btn-default" role="button" href="#">Saber Más</a></p>
                </div>
            </div>
        </section>
    </div>
    <div class="team-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Capitanes del CITT</h2>
                <p class="text-center">Integrantes especializados en variadas disciplinas que trabajan con la tecnología y la innovación.</p>
            </div>
    ...
    <div data-bs-parallax-bg="true" style="height:500px;background-image:url(https://unsplash.it/1800/900?image=1051);background-position:center;background-size:cover;">
        <section>
            <div class="container">
                <div class="jumbotron" style="margin-top:100px;background-color:rgba(238,238,238,0.7);">
                    <h1>Boletín de Proyectos</h1>
                    <p>Estracto ejecutivo de los proyectos registrados por el Centro de Innovación y Transferencia Tecnológica.</p>
                    <p><a class="btn btn-default" role="button" href="#">Saber Más</a></p>
                </div>
            </div>
        </section>
