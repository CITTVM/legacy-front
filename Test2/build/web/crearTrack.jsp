<%-- 
    Document   : crearTrack
    Created on : Jun 20, 2017, 12:01:19 AM
    Author     : jordan
--%>
    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form action="<c:url value="/controllerCrearTrack" />" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit" style="background-color:rgb(43,133,0);max-width:50%;">Crear Track</button>
                </div>
            </form>
        </div>
    </div>
